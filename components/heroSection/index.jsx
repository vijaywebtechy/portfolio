...
const HeroSection = ({ onContactSheet }) => {
        ...
        <div className="md:col-span-9">
          ...
          <div className="flex items-center gap-5 mt-16 flex-wrap">
            <button
              ...
              href="#"
              className="flex items-center justify-center gap-x-3 font-montserrat py-2.5 px-5 border-2 text-base leading-normal rounded-md font-medium
  ...
  shadow-[0_4px_20px_0_rgba(138,43,226,0.5),_0_4px_20px_0_rgba(255,99,71,0.5)]"
            ...
            <button
              href="#"
              className="h-[54px] min-w-40 flex items-center justify-center font-montserrat py-2.5 px-5 text-base border-2 border-gray-400 leading-normal rounded-md font-medium text-gray-600"
            >
              Resume
            </button>
          </div>
