    ...
    <section id="about" className="w-full py-20 bg-white">
      <div className="w-full max-w-6xl mx-auto p-4 flex flex-col md:flex-row">
        ...
        <div className="w-full md:w-6/12">
          ...
          <div className="font-montserrat text-lg leading-relaxed text-gray-800 font-normal">
            <p className="mb-3">
              Hey 👋 there! I'm Vijaya Bhaskar, your friendly neighborhood
              <span className="text-black font-semibold"> Web Developer! </span>
            ...
            <p className="mb-3">
              ...
              and <span className="text-black font-semibold">JavaScript</span>,
              ...
              <span className="text-black font-semibold">ReactJS</span> and{" "}
              <span className="text-black font-semibold">Next.js</span>, I'm all
              about making the web a cooler place to hang out.
            </p>
            <p>
